...
angular.module('APPlanner').controller('ChecklistCtrl', ChecklistCtrl);

function ChecklistCtrl($scope, $rootScope, ionicToast, $ionicModal, $localStorage, $cordovaNetwork, planFactory){
